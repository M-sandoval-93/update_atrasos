...
--
-- Name: apoderados; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: atrasos; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.atrasos OWNER TO postgres;
...
--
-- Name: apoderados id_apoderado; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: atrasos id_atraso; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: inasistencias id_inasistencia; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: apoderados; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.apoderados (id_apoderado, rut_apoderado, dv_rut_apoderado, apellido_paterno_apoderado, apellido_materno_apoderado, nombres_apoderado, estado_apoderado, telefono_apoderado) FROM stdin;
...
--
-- Data for Name: atrasos; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
COPY public.estudiantes (id_estudiante, rut_estudiante, dv_rut_estudiante, apellido_paterno_estudiante, apellido_materno_estudiante, nombres_estudiante, nombre_social_estudiante, fecha_nacimiento_estudiante, id_estado, beneficio_junaeb, sexo_estudiante) FROM stdin;
...
COPY public.funcionarios (id_funcionario, rut_funcionario, dv_rut_funcionario, apellido_paterno_funcionario, apellido_materno_funcionario, nombres_funcionario, sexo_funcionario, fecha_nacimiento_funcionario, id_detalle_tipo_funcionario, id_estado) FROM stdin;
...
COPY public.matriculas (id_matricula, numero_matricula, id_estudiante, id_apoderado_titular, id_apoderado_suplente, id_curso, anio_lectivo, fecha_ingreso_estudiante, fecha_retiro_estudiante) FROM stdin;
...
--
-- Name: apoderados pk_id_apoderado; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: asignaturas pk_id_asignatura; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: atrasos pk_id_atraso; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: cursos pk_id_curso; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: estados pk_id_estado; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: estudiantes pk_id_estudiante; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: inasistencias pk_id_inasistencia; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: matriculas pk_id_matricula; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
CREATE INDEX fki_fk_id_apoderado_titula ON public.matriculas USING btree (id_apoderado_titular);
...
--
-- Name: inasistencias fk_id_apoderado_justifica; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: matriculas fk_id_apoderado_suplente; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: matriculas fk_id_apoderado_titula; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.matriculas
    ADD CONSTRAINT fk_id_apoderado_titula FOREIGN KEY (id_apoderado_titular) REFERENCES public.apoderados(id_apoderado) ON UPDATE CASCADE NOT VALID;


--
-- Name: inasistencias fk_id_asignatura; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: matriculas fk_id_curso; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: funcionarios fk_id_detalle_tipo_funcionario; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: estudiantes fk_id_estado_estudiante; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: funcionarios fk_id_estado_funcionario; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: atrasos fk_id_estudiante; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: matriculas fk_id_estudiante; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: inasistencias fk_id_estudiante; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: usuarios fk_id_funcionario; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: usuarios fk_id_privilegio; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: inasistencias fk_id_tipo_inasistencia; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: atrasos fk_id_usuario_justifica; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
