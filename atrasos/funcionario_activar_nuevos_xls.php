...
header("Expires: 0");
$funcionario_activar_nuevos="funcionario_activar_nuevos.xls";
header("Content-type: application/x-msdownload");
header("Content-Disposition: attachment; filename=$funcionario_activar_nuevos");
...
<!-- primera tabla -->
<div class="panel-heading"> <h1>Funcionarios Nuevos - Activación Nuevo Funcionario </h1> </div>
