...
?>
        ...
        <script>
            ...
            // Función para verificar los valores que se obtienen con las consultas realizadas
            function prueba() {
                alert("Nombre: <?php echo $nombre_alumno; ?>");
                alert("Curso: <?php echo $curso_alumno; ?>   /   Hora Ingreso: <?php echo $hora_atraso; ?>");
                alert("Fecha Ingreso: <?php echo $fecha_atraso; ?>");
                alert("Valor devuelto en insercion: <?php echo $id_atraso; ?>");
        ...
        <script> 
                // Descomentar la función que se utilizara
            //imprimir();
            //prueba();
        </script>
